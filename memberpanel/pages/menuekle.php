...
<form name="menuForm" action="../../inc/islemler.php?islem=menuekle" method="post">
    <div class="form-group">
        <label for="title">Menü Adı</label>
        <input type="text" class="form-control" id="title" name="title" placeholder="Menü Adı Yazınız" required>
