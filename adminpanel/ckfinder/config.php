...
include_once "../ckfinderxxxx/plugins/imageresize/plugin.php";
include_once "../ckfinderxxxx/plugins/fileeditor/plugin.php";
include_once "../ckfinderxxxx/plugins/zip/plugin.php";
