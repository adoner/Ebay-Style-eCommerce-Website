...
function docReady() {
    ...
    $('.thumbnails').on('click', '.gallery-delete', function (e) {
		...
		var kat=$(this).parents('.thumbnail').attr('kat');
		window.location.href = "../modules/galeridelete.php?id=" + encodeURIComponent(id) + "&kat=" + encodeURIComponent(kat);
    ...
    $('.thumbnails').on('click', '.gallery-edit', function (e) {
        e.preventDefault();
        var id=$(this).parents('.thumbnail').attr('id');
		window.location.href = "main.php?page=galeriedit&id=" + encodeURIComponent(id);	
