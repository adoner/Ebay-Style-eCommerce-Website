$(document).ready(function() {
				...
				fileReader.onload = (function(file) {
					...
					return function(e) { 
						...
						if(dataArray.length == 1) {
							$('#upload-button span').html("1 dosya yüklenecek");
						} else {
							$('#upload-button span').html(dataArray.length+" dosya yüklenecek");
						}
	...
	$('#upload-button .upload').click(function() {
		...
		$.each(dataArray, function(index, file) {	
			...
			$.post('/uploads/upload.php', dataArray[index], function(data) {
				...
				if(dataSplit[1] == 'uploaded successfully') {
					var realData = '<li><a href="/images/ilan-images/'+dataSplit[0]+'">'+fileName+'</a> '+dataSplit[1]+'</li>';
					...
					$('#uploaded-files').append('<li><a href="/images/ilan-images/'+data+'. File Name: '+dataArray[index].name+'</li>');
				}
