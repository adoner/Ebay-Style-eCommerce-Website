...
$qry = $db->query("SELECT * FROM members WHERE sehir='bursa' AND onay='1'");
$qry2 = $db->query("SELECT COUNT(*) as num FROM members WHERE sehir='bursa' AND onay='1'");
$rows = $qry2->fetchColumn();
 ?>
<div class="city-container"> 
  <div class="city-image">
	<div class="city-title">Bursa</div>
    <div class="city-info">
<?php foreach($qry as $members){?>
<?php if($rows > 0){?>
<a href="/uye/<?php echo $members["id"];?>">	  
<div style="position:relative; float:left;background-color: #FFF;border: 1px solid #999;border-radius: 1px;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box; width:120px; height:120px; padding: 4px; margin-right:3px">
<div style="background-color: #efefef;border: 1px solid #999;border-radius: 3px;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box; width:110px; height:110px; padding:3px">
