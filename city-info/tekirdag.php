...
$qry = $db->query("SELECT * FROM members WHERE sehir='tekirdağ' AND onay='1'");
$qry2 = $db->query("SELECT COUNT(*) as num FROM members WHERE sehir='tekirdağ' AND onay='1'");
$rows = $qry2->fetchColumn();
 ?>
<div class="city-container"> 
  <div class="city-image">
	<div class="city-title">Tekirdağ</div>
    <div class="city-info">
