...
//			obj.attr(attributes).attr( { fill: "#000" } ); /* set blank colour */
		...
		{				
			...
			/* @author: Taner DOGAN //START */			
				$.get(content_dir+"/"+arr[this.id]+".php", function (html){							
				...
				warn = "<p style='text-align:center;'>Bu şehirde kayıt bulunamadı</p><a href='#' class='close'></a>";
